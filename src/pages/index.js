...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const img = new Image();
    img.src = imageFilenames[currentImageIndex];
    img.onload = () => {
  ...
  return (
    <Fragment>
      ...
      <div className='relative bg-black text-white'>
        ...
        <div className='bg-black w-full lg:h-screen h-screen lg:flex hidden lg:flex-row flex-col items-center justify-center relative'>
